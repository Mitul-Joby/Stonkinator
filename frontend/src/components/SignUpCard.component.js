...
function SignUpCard() {
    ...
    const signUpUser = async (e) => {
        ...
        await axios.post('/account/signup', newUser).then(res => {
            setErrorMessage(null);
            if (res.data.created) {
    ...
    return (
        <div id="signUpCard" className="text-black card shadow" style={{ width: "100%", minWidth: "300px", borderRadius: "30px", marginTop: "110px", marginBottom: "75px" }}>
            <div className="card-body">
                <h2 className="card-title  mb-3 fw-normal">Sign Up</h2>
